...
(function ($) {
	...
	if ($('.header-trans.header-eight').length > 0) {
		$(document).ready(function () {
			$(window).scroll(function () {
				...
				if (scroll > 95) {
					$(".header-trans").css("background", "#000");
				}
	...
	if ($('.header-fourteen').length > 0) {
		$(document).ready(function () {
			$(window).scroll(function () {
				var scroll = $(window).scrollTop();
				if (scroll > 95) {
					$(".header-fourteen").css("background", "#000");
				}
	...
	// 			var scroll = $(window).scrollTop();
	// 			if (scroll > 95) {
	// 				$(".header-fourteen").css("background", "#f5f5f5"); // Set the desired light color
	// 			} else {
	// 				$(".header-fourteen").css("background", "#f5f5f5"); // Set the same light color as the initial background
	// 			}
	// 		})
	// 	})
	// }
	...
	if ($('.header-fifteen').length > 0) {
		$(document).ready(function () {
			$(window).scroll(function () {
				var scroll = $(window).scrollTop();
				if (scroll > 95) {
					$(".header-fifteen").css("background", "#000");
				}
	...
	if ($('.header-sixteen').length > 0) {
		$(document).ready(function () {
			$(window).scroll(function () {
				var scroll = $(window).scrollTop();
				if (scroll > 95) {
					$(".header-sixteen").css("background", "#000");
				}
